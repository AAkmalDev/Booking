...
class CreateStadiumFragment : Fragment(R.layout.fragment_create_stadium) {
    ...
    private var isOutInd: Boolean = false
            ...
            btnAddStadium.setOnClickListener {
                ...
                radioGroup.setOnCheckedChangeListener { group, checkedId ->
                    when(checkedId){
                        R.id.radio_outdoor->{
                            isOutInd = true
                            Log.d("TTTTT", isOutInd.toString())
                        }
                        R.id.radio_indoors->{
                            radioIndoors.isChecked = !isOutInd
                            isOutInd = true
                            Log.d("TTTTT", isOutInd.toString())
                        }
                    }
                ...
                when {
                    ...
                    widht.isEmpty() -> {
                        bn.widthStadium.startAnimation(
                            AnimationUtils.loadAnimation(
                                requireContext(),
                                R.anim.shake
                            )
                    ...
                    height.isEmpty() -> {
                        bn.heightStadium.startAnimation(
                            AnimationUtils.loadAnimation(
                                requireContext(),
                                R.anim.shake
                            )
                    ...
                    timeNight.isEmpty() -> {
                        bn.whenStartNightTime.startAnimation(
                            AnimationUtils.loadAnimation(
                                requireContext(),
                                R.anim.shake
                            )
